...
class WhackAMole {
	...
	constructor(startButton, moles, scoreOut, gameTimeLength, peepTimeMin, peepTimeMax){		
		...
		// Game Images
		this.moleImgSrc = 'https://5.imimg.com/data5/ON/VU/MY-3526621/plastic-bag-500x500.jpg';
		this.moleBonkedImg = new Image();
		this.moleBonkedImg.src = 'https://www.hobsonsbay.vic.gov.au/files/assets/public/images/strategy-and-advocacy/waste/say-no-plastic-bags_1.jpg?w=1200';
		
		// Game Parameters
		this.gameTime = gameTimeLength;
		this.minPeepTime = peepTimeMin;0
